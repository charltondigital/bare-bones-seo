...
class UpdateChecker {
    ...
    public function check_for_updates($transient) {
        ...
        $response = wp_remote_get($api_url, array('user-agent' => 'WordPress/' . get_bloginfo('version')));
        ...
        if (version_compare($remote_version, $plugin_data['Version'], '>')) {
            ...
            $update->package = $release->zipball_url; // Direct download package from GitHub CDN
